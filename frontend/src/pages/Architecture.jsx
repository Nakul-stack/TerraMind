...
const EXECUTION_GUIDES = [
  ...
  },
  {
    ...
    steps: [
      ...
      'AugNosis/Graph retrieval + Ollama synthesize expert context.',
...
function buildOverviewGraph(snapshot) {
  ...
  const nodes = [
    ...
    {
      id: 'overview::external_ollama',
      label: 'Ollama Runtime',
      path: 'external::ollama',
      role: 'external_service',
      layer: 'external',
      color: LAYER_COLORS.external,
      exports: ['Local LLM inference'],
      dependencies: [],
      metadata: {},
    },
    {
  ...
  const edgeDefs = [
    ...
    ['overview::augnosis_engine', 'overview::external_ollama', 'llm synth'],
